...
import {
  PButton as Button,
  PDialogRoot as DialogRoot,
  PDialogTrigger as DialogTrigger,
  PDialogContent as DialogContent,
  PDialogTitle as DialogTitle,
  PDialogDescription as DialogDescription,
  PDialogClose as DialogClose,
  PTooltipProvider as TooltipProvider,
  PTooltipRoot as TooltipRoot,
  PTooltipTrigger as TooltipTrigger,
  PTooltipContent as TooltipContent,
  useThemeProvider,
} from '@phoenix-ui/ui'
...
const baseValues  = ref<Record<string, string>>({})
...
onMounted(() => {
  ...
  nextTick(() => {
    readVarValues()
    baseValues.value = { ...varValues.value }
  })
})
</script>
